...
public class BGWS {
     ...
     */
    @WebMethod(operationName = "bgOp")
    public String bgOp(@WebParam(name = "chapterNumber") int chapterNumber, @WebParam(name = "verseNumber") int verseNumber) {
        String verse = "";
    ...
    @WebMethod(operationName = "bgOpAbst")
    public String bgOpAbst(@WebParam(name = "chapterNumber") int chapterNumber) {
        String abst = "";
        switch (chapterNumber) {
            case 1:
                abst = "As the opposing armies stand poised for battle, Arjuna, the mighty warrior, sees his intimate relatives, teachers and friends in both armies ready to fight and sacrifice their lives. Overcome by grief and pity, Arjuna fails in strength, his mind becomes bewildered, and he gives up his determination to fight.";
                break;
            case 2:
                abst = "Arjuna submits to Lord Krishna as His disciple, and Krishna begins His teachings to Arjuna by explaining the fundamental distinction between the temporary material body and the eternal spiritual soul. The Lord explains the process of transmigration, the nature of selfless service to the Supreme and the characteristics of a self-realized person.";
                break;
            case 3:
                abst = "Everyone must engage in some sort of activity in this material world. But actions can either bind one to this world or liberate one from it. By acting for the pleasure of the Supreme, without selfish motives, one can be liberated from the law of karma (action and reaction) and attain transcendental knowledge of the self and the Supreme.";
                break;
            case 4:
                abst = "Transcendental knowledge-the spiritual knowledge of the soul, of God, and their relationship-is both purifying and liberating. Such knowledge is the fruit of selfless devotional action (karma-yoga). The Lord explains the remote history of the Gita, the purpose and significance of His periodic descents to the material world, and the necessity of approaching a guru, a realized teacher.";
                break;
            case 5:
                abst = "Outwardly performing all actions but inwardly renouncing their fruits, the wise man, purified by the fire of transcendental knowledge, attains peace, detachment, forbearance, spiritual vision and bliss.";
                break;
            case 6:
                abst = "Astanga-yoga, a mechanical meditative practice, controls the mind and the senses and focuses concentration on Paramatma (the Supersoul, the form of the Lord situated in the heart). This practice culminates in samadhi, full consciousness of the Supreme.";
                break;
            case 7:
                abst = "Lord Krishna is the Supreme Truth, the supreme cause and sustaining force of everything, both material and spiritual. Advanced souls surrender unto Him in devotion, whereas impious souls divert their minds to other objects of worship.";
                break;
            case 8:
                abst = "By remembering Lord Krishna in devotion throughout one's life, and especially at the time of death, one can attain to His supreme abode, beyond the material world.";
                break;
            case 9:
                abst = "Lord Krishna is the Supreme Godhead and the supreme object of worship. The soul is eternally related to Him through transcendental devotional service (bhakti). By reviving one's pure devotion one returns to Krishna in the spiritual realm.";
                break;
            case 10:
                ...
                break;
            case 11:
                abst = "Lord Krishna grants Arjuna divine vision and reveals His spectacular unlimited form as the cosmic universe. Thus He conclusively establishes His divinity. Krishna explains that His own all-beautiful humanlike form is the original form of Godhead. One can perceive this form only by pure devotional service.";
                break;
            case 12:
                abst = "Bhakti-yoga, pure devotional service to Lord Krishna, is the highest and most expedient means for attaining pure love for Krishna, which is the highest end of spiritual existence. Those who follow this supreme path develop divine qualities.";
                break;
            case 13:
                abst = "One who understands the difference between the body, the soul and the Supersoul beyond them both attains liberation from this material world.";
                break;
            case 14:
                abst = "All embodied souls are under the control of the three modes, or qualities, of material nature: goodness, passion, and ignorance. Lord Krishna explains what these modes are, how they act upon us, how one transcends them, and the symptoms of one who has attained the transcendental state.";
                break;
            case 15:
                abst = "The ultimate purpose of Vedic knowledge is to detach one self from the entanglement of the material world and to understand Lord Krishna as the Supreme Personality of Godhead. One who understands Krishna 's supreme identity surrenders unto Him and engages in His devotional service.";
                break;
            case 16:
                abst = "Those who possess demoniac qualities and who live whimsically, without following the regulations of scripture, attain lower births and further material bondage. But those who possess divine qualities and regulated lives, abiding by scriptural authority, gradually attain spiritual perfection.";
                break;
            case 17:
                abst = "There are three types of faith, corresponding to and evolving from the three modes of material nature. Acts performed by those whose faith is in passion and ignorance yield only impermanent, material results, whereas acts performed in goodness, in accord with scriptural injunctions, purify the heart and lead to pure faith in Lord Krishna and devotion to Him.";
                break;
            case 18:
                abst = "Krishna explains the meaning of renunciation and the effects of the modes of nature on human consciousness and activity. He explains Brahman realization, the glories of the Bhagavad-gita, and the ultimate conclusion of the Gita: the highest path of religion is absolute, unconditional loving surrender unto Lord Krishna, which frees one from all sins, brings one to complete enlightenment, and enables one to return to Krishna's eternal spiritual abode.";
                break;

            default:
                abst = "Invalid chapter number. Thus, trying for all verse";
                BGWS objBG = new BGWS();
                abst = objBG.bgAllVerse(chapterNumber);
